...
<div class="st-viewbox">
	<div class="article-index st-center">
		...
		<div v-else-if="categorys.length > 0">
			...
			<st-main :cate="categorys[0].id"/>
			<st-articleitem :cate="categorys[0].id"/>
		</div>
...
import Main from '@/components/article/CateMain';
import Refercode from '@/Services/ReferCode';
import Sdk from '@/Services/Sdk';
import Articleitem from '@/components/article/CateArticleitem';
export default {
