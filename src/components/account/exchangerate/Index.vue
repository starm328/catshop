...
<div class="st-viewbox">
	<div class="exchange-index st-center">
...
import ExchangeList from '@/components/account/exchangerate/ExchangeList';
...
<style>
	.mkd_ui.wx .sales-index .st-header .wrap,.sales-index .st-header .wrap {
